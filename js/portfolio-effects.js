/* =========================================
   PORTFOLIO PAGE — LUXURY PARALLAX + 3D EFFECTS
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  revealOnScroll(".portfolio-intro", "section-reveal");
  revealOnScroll(".portfolio-grid", "section-reveal");
  revealOnScroll(".principles-grid", "section-reveal");
  revealOnScroll(".portfolio-cta .simple-cta", "section-reveal");


  /* ---- 3. CURSOR GLARE — portfolio & principle cards ---- */
  ...
  addGlare(".portfolio-card");
  addGlare(".principle-card");
